...
1. Sous l’onglet **Applications** du panneau **Créer un groupe d’applications**, sélectionnez **+ Ajouter des applications**.
1. Dans le panneau **Ajouter une application**, utilisez les onglets **Informations de base** et **Icône** pour spécifier les paramètres suivants, puis sélectionnez **Enregistrer** :
